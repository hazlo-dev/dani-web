...
const benefitCards = document.querySelectorAll(".benefit-card.hidden");

const benefitsSection = document.querySelector(".benefits");

const mainButtons = document.querySelectorAll(".buttons .button.hidden");

const benefitsTitle = document.querySelector(".benefits h2.hidden");


if (benefitsSection && benefitCards.length && mainButtons.length) {

    const lastMainButton = mainButtons[mainButtons.length - 1];

    lastMainButton.addEventListener("animationend", () => {
...
const tranquility = Array.from(
    ...
    return card.querySelector("h3")?.textContent.trim() === "Tranquilidad";
...
const processTimelineLines = document.querySelectorAll(
...
if (tranquility && processSection) {
    ...
    tranquility.addEventListener("animationend", () => {
